...
export const GUIDE3: Record<CategoryId, {
  ...
  population: {
    ...
    regional: "Definitions vary by culture as much as by data: US 'city' populations are legally small (city limits), European figures often mean urban continuum, and Asian megacities blur province-scale — which is why every comparison here states its metro-ish convention and treats cross-cultural absolutes as orientation, not gospel.",
    gloss: [
      ["Lower bound", "What a major-city sum guarantees: the true population is at least this."],
