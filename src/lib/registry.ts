...
export const TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    related: ["route-optimizer", "driving-distance-calculator", "drive-time-map"],
  },
  {
    slug: "kml-viewer",
    name: "KML Viewer",
    ...
    howTo: ["Choose a KML or KMZ file.", "Inspect features on the map.", "Export or copy coordinates if needed."],
